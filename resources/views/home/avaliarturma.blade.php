...
<div class="container container-fluid">
    <form method="POST" action="{{ route('api.avaliarturma', [$disciplina, $aluno]) }}">
        ...
        <section class="container grid grid-c3">
            <div class="item">
            <textarea name="questoes" id="questoes" disabled class="form-control" style="resize: none;
                @foreach($questoes as $quest)
                <?php $q = explode(',', $quest->quest) ?>
                overflow: hidden; font-family: serif; width: 100px; height: 380px; font-weight: bold; font-size: 158%">
@for($i = 0; $i < 10; $i++)
{{ $i+1 }} - {{ $q[$i]}}
@endfor
                @endforeach
        ...
        <input name="nota" type="number" min="0" max="10" value="0" class="form-control" style="width: 150px" id="nota">
        <br />
